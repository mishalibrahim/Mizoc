...
const Footer = () => {
  return (
    <footer
      className="relative bottom-0 rounded-t-[40px] overflow-hidden z-20 bg-gradient-to-b from-primary from-0% to-[#532753] to-100% "
      id="contactUs"
    >
      ...
      <div className="wrapper ">
        <div className="flex justify-between sm:flex-row flex-col sm:pt-10 sm:pb-0 pb-4 pt-8">
          <div className="flex-1 ">
            <p className="font-medium sm:text-[36px] text-[24px] text-white">
              Mizoc LLC
            </p>
          </div>
          <div className="flex-1 ">
            <p className="font-semibold sm:text-[64px] text-[44px] text-white">
              Lets Get Started
            </p>
            <Form />
          </div>
        ...
        <div className="flex justify-between flex-col sm:flex-row">
          ...
          <div className="flex sm:items-start  justify-end flex-col gap-1">
            ...
            <div className="flex  gap-2">
              <Phone />
              <Link
                href="tel:+971501452837"
                className="text-white min-w-[145px]"
              >
                +971501452837
              </Link>
            </div>
